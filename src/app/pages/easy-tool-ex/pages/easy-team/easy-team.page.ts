...
@Component({
  selector: 'app-easy-team',
  templateUrl: './easy-team.page.html',
  styleUrls: ['./easy-team.page.scss'],
})
export class EasyTeamPage implements OnInit {
  ...
  navigateToPlayer(id: number) {
    this.router.navigate([
      `/easy-tool/team/${this.teamId}/player/${id}/${this.id}`,
    ]);
  }
